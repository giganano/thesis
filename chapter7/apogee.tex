...
\caption{
Age (left) and abundance (middle and right) distributions for stars within
$\left|z\right| \leq 0.5$ kpc of the disk midplane at different radii
(see~\S~\ref{outflows:sec:empirical:sample} for discussion of our sample).
...
As a result, the value added catalog is a factor of~$\sim$$2.5$ larger,
