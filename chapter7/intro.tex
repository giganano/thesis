...
% 	{\color{red} (ref some review article)}.

% 	\item Within the MW, direct measurements made more precise in recent
% 	years with the advent of large-scale spectroscopic surveys of the Galactic
% 	disk.
