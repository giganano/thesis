...
\vice's\linebreak\texttt{vice.yields.ccsne.fractional} function assuming a
...
\begin{figure*}
\centering
\includegraphics[scale = 0.48]{agb_yield_models.pdf}
\caption{
...
\begin{figure*}
\centering
\includegraphics[scale = 0.51]{agb_yield_models_imfweighted.pdf}
\includegraphics[scale = 0.5]{ssp_production_modelcomp.pdf}
