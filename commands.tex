...
\newcommand{\gradage}{\ensuremath{\nabla\tau_{1/2}}}
\newcommand{\timescale}[1]{\ensuremath{\tau_\text{#1}}}
\newcommand{\muflow}[1]{\ensuremath{\mu_{\flow,\text{#1}}}}
\newcommand{\taupsi}[1]{\ensuremath{\tau_{\psi,\text{#1}}}}
% \newcommand{\overequalsign}[1]{\stackrel{\mathclap{\mbox{\ensuremath{#1}}}}{=}}

% final chapter -> Weinberg, Andrews & Freudenburg (2017) -> WAF17
\defcitealias{Weinberg2017b}{WAF17}
