...
equation~\refp{dga:eq:chisquared_dof} is noted at the bottom.
}
\begin{tabularx}{\linewidth}{c @{\extracolsep{\fill}} c c c c}
\hline
Parameter & GSE & GSE (no ages) &
Wukong/LMS-1 (fixed yields) & Wukong/LMS-1 (free yields)
\\
\hline
$\tau_\text{in}$ &
$1.01 \pm 0.13$ Gyr &
