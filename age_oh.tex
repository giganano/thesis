...
\begin{figure*} 
\centering
\includegraphics[scale = 0.38]{chapter5/age_oh_comparison.pdf} 
\caption{The same as Fig.~\ref{migration:fig:amr_insideout_vs_lateburst_fe},
but for~\oh, and with an additional comparison to the outer-burst model in the 
bottom row.} 
